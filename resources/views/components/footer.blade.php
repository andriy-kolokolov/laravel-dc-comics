    ...
    <div class="footer__middle">
        <div class="container">
            ...
            <div class="footer__middle__right">
                <img class="footer-logo-img" src="{{ Vite::asset('/resources/img/dc-logo-bg.png') }}" alt=""/></div>
        </div>
        ...
        <img class="footer__bg-img" src="{{ Vite::asset('/resources/img/footer-bg.jpg') }}" alt="footer background"/>
    </div>
